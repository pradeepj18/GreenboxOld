...
<title>GreenBox | Tournament Stats</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
...
<body>
	...
	<div class="row">
		...
		<div class="col s12 m12 l3 hide-on-med-and-down">
			...
			<div class="card-panel" style="overflow-x:hidden;">
			<div class="fb-post"
		data-href="https://www.facebook.com/greenboxpune/photos/a.718510694891315.1073741828.714338225308562/1957025387706500/?type=3"
		...
		<div class="fb-post"
		data-href="https://www.facebook.com/greenboxpune/photos/a.718510694891315.1073741828.714338225308562/1957027461039626/?type=3"
		data-width="500"
		data-show-text="true">
		...
		<div class="card-panel" style="overflow:auto;">
			<div class="fb-page" data-href="https://www.facebook.com/greenboxpune/"
		...
		<ul class="side-nav" id="mobile-demo">
			...
			<li><a id="tourH1">Tournament History</a></li>
			<li><a id="teamH1">Team History</a></li>
			<li><a id="matchH1">Match History</a></li>
			<li><a id="dayH1">Day Wise Matches</a></li>
			<li><a id="topperH1">Topper</a></li>
		</ul>
		<div class="col s12 m12 l9">
			...
			<div class="card-panel  light-blue darken-4 white-text"><span class="history-title-text">Team History</span></div>
				<div class="card-panel grey lighten-4">
					...
					boolean f=false;
					rs=null;rs1=null;
					rs=DBManager.fetchQuery("select ttId,(select tName from team where tid in(select tid from tourTeam where ttId=tt.ttId)) as tname,(select lcase(SUBSTRING_INDEX(tFlag,'/',-1)) from team where tid in(select tid from tourTeam where ttId=tt.ttId)) as flag from tourTeam tt where tourId=1;");
					while(rs.next())
					{
	...
	<% }%>
 	...
 	<div class="card-panel  light-blue darken-4 white-text"><span class="history-title-text">Rank Holders</span></div>
		...
		<div class="col s12 m12 l12">
			<div class="card">
				<center><img src="images/winner.JPG" class="responsive-img"></center>
			</div>
		</div>
	</div>
	<div class="row">
		...
		<div class="s12 m8 l8">
				<div id="fb-root" class="video-container"></div>
				<div class="fb-video" data-href="https://www.facebook.com/greenboxpune/videos/1957103141032058/" data-width="620" style="margin-top: 0.5%; margin-left: 1%;" data-show-text="false">
				 </div>
		</div>
